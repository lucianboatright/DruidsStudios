...
const items = [
  ...
  { id: 2,  category: "Theater",company: 'Samsung', details: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex', content:  <div><img style={{  height: 'auto', maxWidth: '100%', display: 'block'}} src={image1} alt='Image'/><img style={{ height: 'auto', maxWidth: '100%', display: 'block'}} src={image2} alt='Image'/></div>},
  { id: 4, category: "Props", company: 'Google', details: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', content:  <div><img style={{  height: 'auto', maxWidth: '100%', display: 'block'}} src={image1} alt='Image'/><img style={{ height: 'auto', maxWidth: '100%', display: 'block'}} src={image2} alt='Image'/></div>},
